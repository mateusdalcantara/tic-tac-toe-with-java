package com.mateusdalcantara.resources;
/** Simulate of a Tic-Tac-Toe game */
public class TicTacToe {
    public static final int X = 1, O = -1; //player
    ...
    /** Returns the winning player's code, or 0(zero) to indicate a tie (or unfinished game).*/
    public int winner() {
        if (isWin(X))
            return (X);
        else if (isWin(O))
